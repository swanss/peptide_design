...
void writeStructureCoordinates(const Structure &s, ofstream &out, string chainID, string atomMode, bool isPointCloud, ColorFunction colorFn) {
...
int main (int argc, char *argv[]) {
    ...
    if (opts.isGiven("clusters")) {
        ...
        while (it.hasNext()) {
            ...
            writeStructureCoordinates(s, out, "", atomMode, outFileExt == "pcloud", [&](ofstream &out, string ssID, Atom *a) {
                out << address;
            });
        }
